...
BankInfoBean _$BankInfoBeanFromJson(Map<String, dynamic> json) => BankInfoBean(
      ...
      json['saltyComfortablePlatformKingdom'] as String?,
      json['swissEnoughSaying'] as String?,
    );
...
Map<String, dynamic> _$BankInfoBeanToJson(BankInfoBean instance) =>
    <String, dynamic>{
      ...
      'firstNurse': instance.firstNurse,
      'saltyComfortablePlatformKingdom':
          instance.saltyComfortablePlatformKingdom,
      'swissEnoughSaying': instance.swissEnoughSaying,
    };
