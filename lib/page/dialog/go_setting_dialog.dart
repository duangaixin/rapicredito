...
class GoSettingDialog extends StatefulWidget {
  ...
  const GoSettingDialog({
    Key? key,
    required this.clickConfirm,
  }) : super(key: key);
}

class _GoSettingDialogState extends State<GoSettingDialog> {
  @override
      ...
      child: Column(
        ...
        children: [
          const Padding(
            ...
            child: Text(
              'Para brindarle un buen servicio, active los permisos correspondientes en la configuración del teléfono',
