...
public class CalendarReminderUtils {
    ...
    private static String CALENDARS_NAME = "rapicredito";
    private static String CALENDARS_ACCOUNT_NAME = "";
    private static String CALENDARS_ACCOUNT_TYPE = "";
    private static String CALENDARS_DISPLAY_NAME = "rapicredito";
    ...
    private static int checkCalendarAccount(Context context) {
        ...
        try {
            ...
            if (count > 0) {
                ...
                int idIndex = userCursor.getColumnIndex(CalendarContract.Calendars._ID);
                return userCursor.getInt(idIndex);
            } else {
                return -1;
            }
        } finally {
    ...
    public static void addCalendarEvent(Context context, String title, String description, long reminderTime, int previousDate) {
        ...
        event.put(CalendarContract.Events.EVENT_TIMEZONE, "UTC/GMT");
            ...
            if (eventCursor.getCount() > 0) {
                for (eventCursor.moveToFirst(); !eventCursor.isAfterLast(); eventCursor.moveToNext()) {
                    ...
                    if (!TextUtils.isEmpty(title) && title.equals(eventTitle)) {
                        ...
                        int id = eventCursor.getInt(idIndex);
